...
export default function Faq() {
  ...
  return (
    <div className="faq my-[150px] 2xl:px-[0] xl:px-[20px] sm:px-[10px] px-[5px] ">
      <div className="container  ">
        ...
        <div className="faq_question flex flex-col gap-[20px] border-b-[1px] mt-[30px] py-[30px] pb-[40px] border-gray">
          <div className="question flex w-full justify-between ">
            <Text
              f_size="text-[32px]"
              f_weight="font-[700]"
              t_color="text-gray-700"
            >
